...
export class CrmFleetModal extends Component {
  ...
  handleAddFleet = async (fleetData, isEditMode) => {
    try {
      ...
      let fleetData1 = { ...fleetData, companyName: fleetData.companyName.trim() }
                  ...
                  <FormGroup>
                    ...
                    <div className={"input-block"}>
                      <Input
                        ...
                        maxLength="50"
                        id="name"
                        invalid={errors.companyName && !(companyName.trim())}
                      />
                      <FormFeedback>
